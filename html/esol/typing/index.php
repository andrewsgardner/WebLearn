<?php 
$currentPage = "esol";
$pageTitle = "Typing | ESOL Lab";
$pageDesc = "Typing distance learning activities for English for Speakers of Other Languages students.";
$activityCount = 0;
$refCount = 0;
...
<ol class="breadcrumb">
    ...
    <li><a href="<?php echo $esolRoutes['compLit']['typing']; ?>">Typing</a></li>
</ol>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="activity">
            <h3><a href="https://abeweb.mpls.k12.mn.us/type/10-US-States.html" target="_blank" class="alt-link-color"><?php echo ++$activityCount . ". "; ?>U.S. States</a></h3>
            <p>Practice typing out the names of U.S. States.</p>
            <div class="activity-thumbnail">
                <img src="<?php echo $config['paths']['img']['content'] . '/us-states.png'; ?>" alt="U.S. States">
            </div>
            <div class="activity-open">
                <p><a href="https://abeweb.mpls.k12.mn.us/type/10-US-States.html" target="_blank" class="btn btn-primary" role="button">Open</a></p>
            </div>
        </div>
        
        <div class="activity">
            <h3><a href="https://abeweb.mpls.k12.mn.us/type/02-Countries.html" target="_blank" class="alt-link-color"><?php echo ++$activityCount . ". "; ?>Countries of the World</a></h3>
            <p>Practice typing out the names of different countries.</p>
            <div class="activity-thumbnail">
                <img src="<?php echo $config['paths']['img']['content'] . '/countries-of-the-world.png'; ?>" alt="Countries of the World">
            </div>
            <div class="activity-open">
                <p><a href="https://abeweb.mpls.k12.mn.us/type/02-Countries.html" target="_blank" class="btn btn-primary" role="button">Open</a></p>
            </div>
        </div>
        
        <div class="activity">
            <h3><a href="https://abeweb.mpls.k12.mn.us/type/03-Cities.html" target="_blank" class="alt-link-color"><?php echo ++$activityCount . ". "; ?>Large Cities of the World</a></h3>
            <p>Practice typing out the names of different cities from around the world.</p>
            <div class="activity-thumbnail">
                <img src="<?php echo $config['paths']['img']['content'] . '/large-cities-of-the-world.png'; ?>" alt="Large Cities of the World">
            </div>
            <div class="activity-open">
                <p><a href="https://abeweb.mpls.k12.mn.us/type/03-Cities.html" target="_blank" class="btn btn-primary" role="button">Open</a></p>
            </div>
        </div>
        
        <div class="activity">
            <h3><a href="https://abeweb.mpls.k12.mn.us/type/01-Names.html" target="_blank" class="alt-link-color"><?php echo ++$activityCount . ". "; ?>Common American Names</a></h3>
            <p>Practice typing out common American names.</p>
            <div class="activity-thumbnail">
                <img src="<?php echo $config['paths']['img']['content'] . '/common-american-names.png'; ?>" alt="Common American Names">
            </div>
            <div class="activity-open">
                <p><a href="https://abeweb.mpls.k12.mn.us/type/01-Names.html" target="_blank" class="btn btn-primary" role="button">Open</a></p>
            </div>
        </div>
        
        <div class="activity">
            <h3><a href="https://abeweb.mpls.k12.mn.us/type/07-Classroom-Vocabulary.html" target="_blank" class="alt-link-color"><?php echo ++$activityCount . ". "; ?>Common Classroom Terms</a></h3>
            <p>Practice typing out common classroom vocabulary.</p>
            <div class="activity-thumbnail">
                <img src="<?php echo $config['paths']['img']['content'] . '/common-classroom-terms.png'; ?>" alt="Common Classroom Terms">
            </div>
            <div class="activity-open">
                <p><a href="https://abeweb.mpls.k12.mn.us/type/07-Classroom-Vocabulary.html" target="_blank" class="btn btn-primary" role="button">Open</a></p>
            </div>
        </div>
        ...
        <div class="credits alt-link-color">
            ...
            <p><?php echo ++$refCount . ". "; ?><a href="https://abeweb.mpls.k12.mn.us/type/10-US-States.html" target="_blank">Minneapolis ABE Touch Typing Curriculum</a>.</p>
            <p><?php echo ++$refCount . ". "; ?><a href="https://abeweb.mpls.k12.mn.us/type/02-Countries.html" target="_blank">Minneapolis ABE Touch Typing Curriculum</a>.</p>
            <p><?php echo ++$refCount . ". "; ?><a href="https://abeweb.mpls.k12.mn.us/type/03-Cities.html" target="_blank">Minneapolis ABE Touch Typing Curriculum</a>.</p>
            <p><?php echo ++$refCount . ". "; ?><a href="https://abeweb.mpls.k12.mn.us/type/01-Names.html" target="_blank">Minneapolis ABE Touch Typing Curriculum</a>.</p>
            <p><?php echo ++$refCount . ". "; ?><a href="https://abeweb.mpls.k12.mn.us/type/07-Classroom-Vocabulary.html" target="_blank">Minneapolis ABE Touch Typing Curriculum</a>.</p>
        </div>
