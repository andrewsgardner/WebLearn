...
You can reference ```contentPage.php``` when creating a new page by using this template:
...
You can reference ```activityList.php``` when creating a new activity list page by using this template:
