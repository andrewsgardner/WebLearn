...
You can reference ```contentPage.php``` in the front-end when creating a new page like this:
...
You can reference ```activityList.php``` in the front-end when creating a new activity list page like this:
