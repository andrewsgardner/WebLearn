<?php 
$currentPage = "abe";
$pageTitle = "Search Engines | ABE Lab";
$pageDesc = "Distance learning activities about using search engines for Adult Basic Education students.";
$activityCount = 0;
$refCount = 0;
...
<ol class="breadcrumb">
    ...
    <li><a href="<?php echo $abeRoutes['compLit']['searchEngines']; ?>">Search Engines</a></li>
</ol>
