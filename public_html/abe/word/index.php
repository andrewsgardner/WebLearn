<?php 
$currentPage = "abe";
$pageTitle = "ABE Lab | Microsoft Word";
$pageDesc = "Distance learning activities about Microsoft Word for Adult Basic Education students.";
$activityCount = 0;
$refCount = 0;
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="activity">
            <h3><a href="<?php echo $abeRoutes['compLit']['introToWord']; ?>" class="alt-link-color"><?php echo ++$activityCount . ". "; ?>Introduction to Microsoft Word 2013</a></h3>
            ...
            <div class="activity-open">
                <p><a href="<?php echo $abeRoutes['compLit']['introToWord']; ?>" class="btn btn-primary" role="button">Open</a></p>
            </div>
        </div>
        
        <div class="activity">
            <h3><a href="<?php echo $abeRoutes['compLit']['savingPrinting']; ?>" class="alt-link-color"><?php echo ++$activityCount . ". "; ?>Saving &amp; Printing Documents</a></h3>
            ...
            <div class="activity-open">
                <p><a href="<?php echo $abeRoutes['compLit']['savingPrinting']; ?>" class="btn btn-primary" role="button">Open</a></p>
            </div>
        </div>
        
        <div class="activity">
            <h3><a href="<?php echo $abeRoutes['compLit']['formattingDocs']; ?>" class="alt-link-color"><?php echo ++$activityCount . ". "; ?>Formatting Documents</a></h3>
            ...
            <div class="activity-open">
                <p><a href="<?php echo $abeRoutes['compLit']['formattingDocs']; ?>" class="btn btn-primary" role="button">Open</a></p>
            </div>
        </div>
        
        <div class="activity">
            <h3><a href="<?php echo $abeRoutes['compLit']['insertImgTables']; ?>" class="alt-link-color"><?php echo ++$activityCount . ". "; ?>Insert Images &amp; Tables</a></h3>
            ...
            <div class="activity-open">
                <p><a href="<?php echo $abeRoutes['compLit']['insertImgTables']; ?>" class="btn btn-primary" role="button">Open</a></p>
            </div>
        </div>
        
        <div class="activity">
            <h3><a href="<?php echo $abeRoutes['compLit']['pageLayoutDesign']; ?>" class="alt-link-color"><?php echo ++$activityCount . ". "; ?>Page Layout &amp; Design</a></h3>
            ...
            <div class="activity-open">
                <p><a href="<?php echo $abeRoutes['compLit']['pageLayoutDesign']; ?>" class="btn btn-primary" role="button">Open</a></p>
            </div>
        </div>
