<?php 
$currentPage = "abe";
$pageTitle = "ABE Lab | Place Value Video 2";
...
<ol class="breadcrumb">
    ...
    <li><a href="<?php echo $abeRoutes['math']['placeValueV2']; ?>">Video 2</a></li>
</ol>
...
<div class="row">
   <div class="col-xs-12">
      ...
      <h2>Exploring Place Value - Video 2</h2>
       <div class="video-container">
         <div class="embed-video">
            <iframe src="https://www.youtube.com/embed/jxA8MffVmPs" frameborder="0" allowfullscreen></iframe>
         </div>
      </div>
   </div>
</div>
