...
<ol class="breadcrumb">
    ...
    <li><a href="<?php echo $abeRoutes['math']['placeValueV3']; ?>">Video 3</a></li>
</ol>
...
<div class="row">
   <div class="col-xs-12">
      ...
      <h2>Exploring Place Value - Video 3</h2>
       <div class="video-container">
         <div class="embed-video">
            <iframe src="https://www.youtube.com/embed/iK0y39rjBgQ" frameborder="0" allowfullscreen></iframe>
         </div>
      </div>
   </div>
</div>
