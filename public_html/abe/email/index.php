<?php 
$currentPage = "abe";
$pageTitle = "ABE Lab | Email";
$pageDesc = "Distance learning activities about email for Adult Basic Education students.";
$activityCount = 0;
$refCount = 0;
...
<ol class="breadcrumb">
    ...
    <li><a href="<?php echo $abeRoutes['compLit']['email']; ?>">Email</a></li>
</ol>
