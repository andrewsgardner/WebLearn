<?php 
$currentPage = "abe";
$pageTitle = "Topics &amp; Main Ideas | ABE Lab";
...
<ol class="breadcrumb">
    ...
    <li><a href="<?php echo $abeRoutes['english']['topicsMainIdeas']; ?>">Topics &amp; Main Ideas</a></li>
</ol>
...
<div class="row">
   <div class="col-xs-12">
      ...
      <h2>Topics &amp; Main Ideas</h2>
       <div class="video-container">
         <div class="embed-video">
            <iframe src="https://www.youtube.com/embed/5Jt0Q2J2sdo" frameborder="0" allowfullscreen></iframe>
         </div>
      </div>
   </div>
</div>
