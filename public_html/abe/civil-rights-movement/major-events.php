...
<ol class="breadcrumb">
    ...
    <li><a href="<?php echo $abeRoutes['socialStudies']['majorEvents']; ?>">Major Events</a></li>
</ol>
...
<div class="row">
   <div class="col-xs-12">
      ...
      <h2>The Civil Rights Movement: Major Events</h2>
       <div class="video-container">
         <div class="embed-video">
            <iframe src="https://www.youtube.com/embed/URxwe6LPvkM" frameborder="0" allowfullscreen></iframe>
         </div>
      </div>
   </div>
</div>
