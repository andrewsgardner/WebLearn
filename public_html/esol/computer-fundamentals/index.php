<?php 
$currentPage = "esol";
$pageTitle = "Computer Fundamentals | ESOL Lab";
$pageDesc = "Basic computer skills distance learning activities for English for Speakers of Other Languages students.";
$activityCount = 0;
$refCount = 0;
...
<ol class="breadcrumb">
    ...
    <li><a href="<?php echo $esolRoutes['compLit']['compFundamentals']; ?>">Computer Fundamentals</a></li>
</ol>
