<?php 
$currentPage = "esol";
$pageTitle = "Windows 7 | ESOL Lab";
$pageDesc = "Windows 7 distance learning activities for English for Speakers of Other Languages students.";
$activityCount = 0;
$refCount = 0;
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="activity">
            <h3><a href="<?php echo $esolRoutes['compLit']['introDesktop']; ?>" class="alt-link-color"><?php echo ++$activityCount . ". "; ?>Introduction to the Desktop</a></h3>
            ...
            <div class="activity-open">
                <p><a href="<?php echo $esolRoutes['compLit']['introDesktop']; ?>" class="btn btn-primary" role="button">Open</a></p>
            </div>
        </div>
        
        <div class="activity">
            <h3><a href="<?php echo $esolRoutes['compLit']['introStartMenu']; ?>" class="alt-link-color"><?php echo ++$activityCount . ". "; ?>Introduction to the Start Menu</a></h3>
            ...
            <div class="activity-open">
                <p><a href="<?php echo $esolRoutes['compLit']['introStartMenu']; ?>" class="btn btn-primary" role="button">Open</a></p>
            </div>
        </div>
        
        <div class="activity">
            <h3><a href="<?php echo $esolRoutes['compLit']['windowFunctions']; ?>" class="alt-link-color"><?php echo ++$activityCount . ". "; ?>Basic Window Functions</a></h3>
            ...
            <div class="activity-open">
                <p><a href="<?php echo $esolRoutes['compLit']['windowFunctions']; ?>" class="btn btn-primary" role="button">Open</a></p>
            </div>
        </div>
        
        <div class="activity">
            <h3><a href="<?php echo $esolRoutes['compLit']['navPersonalFolders']; ?>" class="alt-link-color"><?php echo ++$activityCount . ". "; ?>Navigating Your Personal Folders</a></h3>
            ...
            <div class="activity-open">
                <p><a href="<?php echo $esolRoutes['compLit']['navPersonalFolders']; ?>" class="btn btn-primary" role="button">Open</a></p>
            </div>
        </div>
