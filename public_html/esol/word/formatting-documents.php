<?php 
$currentPage = "esol";
$pageTitle = "Formatting Documents in Word | ESOL Lab";
$pageDesc = "Learn how to make Microsoft Word documents more visually appealing and easier to read on the Springfield Adult Learning Center's ESOL Lab.";
...
<ol class="breadcrumb">
    ...
    <li><a href="<?php echo $esolRoutes['compLit']['formattingDocs']; ?>">Formatting Documents</a></li>
</ol>
