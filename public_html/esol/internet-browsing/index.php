<?php 
$currentPage = "esol";
$pageTitle = "Internet Browsing | ESOL Lab";
$pageDesc = "Distance learning activities about Internet browsing for English for Speakers of Other Languages students.";
$activityCount = 0;
$refCount = 0;
...
<ol class="breadcrumb">
    ...
    <li><a href="<?php echo $esolRoutes['compLit']['internetBrowsing']; ?>">Internet Browsing</a></li>
</ol>
